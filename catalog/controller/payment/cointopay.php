		...
		try {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
				...
				if ($php_arr->error == '' || empty($php_arr->error)) {
					$this->model_checkout_order->addHistory($php_arr->CustomerReferenceNr, $this->config->get('payment_cointopay_order_status_id'), 'Transaction #' . $php_arr->TransactionID . ' Created on cointopay for OrderID #' . $php_arr->CustomerReferenceNr . ' with status Processing', false);
					//print_r($php_arr);
			...
			if (200 !== $transactionData['status_code']) {
				...
				if ($transactionData['data']['Security'] != $_REQUEST['ConfirmCode']) {
					...
					if ($_REQUEST['status'] == 'paid' && $_REQUEST['notenough'] == 0) {
						...
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_success_order_status_id', 'Successfully Paid'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to completed for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
						...
						$statusProcessed = 15;
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_notenough_order_status_id'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to pending (underpaid) for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
						...
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_failed_order_status_id', 'Transaction payment failed'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to failed for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
						...
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_expired_order_status_id'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to expired for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
						...
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_notenough_order_status_id'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to pending (' . $_REQUEST['status'] . ') for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
						...
						$this->model_checkout_order->addHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_callback_cancel_order_status_id'), 'Cointopay Transaction #' . $_REQUEST['TransactionID'] . ' Set to Canceled for OrderID #' . $_REQUEST['CustomerReferenceNr'], false);
